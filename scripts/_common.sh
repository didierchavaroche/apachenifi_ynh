...
__install_keystore() {
    ...
    $JAVA_HOME/bin/keytool -importcert -alias nifi-cert -file $install_dir/nifi-cacert.pem -keystore $install_dir/conf/truststore.jks -deststorepass $keystorepasswd -noprompt
