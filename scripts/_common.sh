...
__install_keystore() {
    ...
    keytool -storepasswd -new $keystorepasswd -importkeystore -srckeystore $install_dir/nifi.p12 -srcstoretype pkcs12 -srcalias nifi-key -destkeystore $install_dir/conf/keystore.jks -deststoretype jks -destalias nifi-key
